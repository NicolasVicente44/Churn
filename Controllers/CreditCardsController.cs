...
namespace Churn.Controllers
{
    ...
    public class CreditCardsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InterestRate,MinimumPaymentAmount,AnnualFee,BalanceTransferAmount,Id,Name,Description")] CreditCard creditCard)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InterestRate,MinimumPaymentAmount,AnnualFee,BalanceTransferAmount,Id,Name,Description")] CreditCard creditCard)
        {
            if (id != creditCard.Id)
            {
                return NotFound();
